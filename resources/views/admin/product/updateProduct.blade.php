...
<body>
    ...
    <div class="container content-container">
        <form method="post" action={{$product->p_id}} enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="p_id" class="form-label">ID</label>
                <input type="text" class="form-control" name="p_id" id="p_id" placeholder="" value="{{$product->p_id}}">
            </div>
            <div class="mb-3">
                <label for="tittle" class="form-label">Tên sản phẩm</label>
                <input type="text" class="form-control" name="tittle" id="tittle" placeholder="" value="{{$product->tittle}}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="price" id="price" placeholder="" value="{{$product->price}}">
            </div>
            <div class="mb-3">
                <label for="img" class="form-label">Chọn Ảnh</label>
                <img scr="{{$product->thumbnail}} alt="Image>
